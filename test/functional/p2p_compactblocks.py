...
# TestP2PConn: A peer we use to send messages to xsnd, and store responses.
...
class CompactBlocksTest(XSNTestFramework):
    ...
    # This test actually causes xsnd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that xsnd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for xsnd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # xsnd will not send blocktxn responses for blocks whose height is
