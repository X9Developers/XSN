...
"""Verify that starting xsn with -h works as expected."""
import subprocess

from test_framework.test_framework import XSNTestFramework
from test_framework.util import assert_equal

class HelpTest(XSNTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xsn with -h for help text")
        ...
        self.log.info("Start xsn with -version for version information")
