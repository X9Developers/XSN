...
public:
    ...
    // because it's used in many Xsn-specific places (masternode, privatesend).
    CNode* ConnectNode(CAddress addrConnect, const char *pszDest = NULL, bool fConnectToMasternode = false, bool fConnectToMerchantnode = false);
