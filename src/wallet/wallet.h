...
public:
    ...
    /// Get 1000XSN output and keys which can be used for the Masternode
    ...
    bool GetMerchantnodeOutpointAndKeys(COutPoint& outpointRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
