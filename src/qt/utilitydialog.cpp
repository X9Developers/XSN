    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("XSN Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About XSN Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  xsn-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the XSN in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XSN, 0.1 XSN, 1 XSN and 10 XSN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://xsnpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://xsnpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("XSN Core is shutting down...") + "<br /><br />" +
