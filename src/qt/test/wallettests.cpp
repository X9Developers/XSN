...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<XSNAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_xsn-qt -platform xcb      # Linux
//     src/qt/test/test_xsn-qt -platform windows  # Windows
//     src/qt/test/test_xsn-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = XSNUnits::formatWithUnit(unit, balance, false, XSNUnits::separatorAlways);
    ...
    // Amount input
    XSNAmountField* amountInput = receiveCoinsDialog.findChild<XSNAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: xsn:")) != -1);
