...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case DASH: return QString("Xsn");
            case mDASH: return QString("Milli-Xsn (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-Xsn (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    ...
    else
    {
        switch(unit)
        {
            case DASH: return QString("TestXsns");
            case mDASH: return QString("Milli-TestXsn (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-TestXsn (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-TestXsn (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
}
