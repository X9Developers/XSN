...
### Build and sign Dash Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit xsn=v${VERSION} ../xsn/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Release on Dash forum: https://www.xsn.org/forum/topic/official-announcements.54/
