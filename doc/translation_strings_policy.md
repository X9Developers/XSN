...
This document provides guidelines for internationalization of the XSN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xsn_en.ts` remains unchanged.
