XSN Core version 0.11.2 is now available from:

  <https://xsn.org/bin/xsn-core-0.11.2/>
...
- #6600 `1e672ae` Debian/Ubuntu: Include xsn-tx binary
- #6600 `2394f4d` Debian/Ubuntu: Split xsn-tx into its own package
