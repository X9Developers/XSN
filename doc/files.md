...
* xsn.conf: contains configuration settings for xsnd or xsn-qt
* xsnd.pid: stores the process id of xsnd while running
...
* debug.log: contains debug information and general logging generated by xsnd or xsn-qt
